...
- **[scenes/Main.tscn](scenes/Main.tscn)** - Root game scene
  ...
  - Spawns 42 territory instances
  
- **[scenes/Territory.tscn](scenes/Territory.tscn)** - Territory node template
  - ColorRect for visual representation
...
### Core Controllers
- **[scripts/Main.gd](scripts/Main.gd)** ⭐ START HERE
...
### UI Controllers
- **[scripts/Territory.gd](scripts/Territory.gd)**
  - Individual territory behavior
...
- **[resources/map_data.json](resources/map_data.json)** ⭐ MAP DATA
  - 42 territories with neighbor relationships
  - Continent assignments

- **[resources/continents.json](resources/continents.json)** ⭐ CONTINENT DATA
